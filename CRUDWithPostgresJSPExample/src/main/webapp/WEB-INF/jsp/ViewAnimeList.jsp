...
<body>
    ...
    <div class="container">
        ...
        <h1 class="p-3"> Employee Table List</h1>
        ...
        <form:form>
            ...
            <table class="table table-bordered">
            	...
            	<c:forEach var="anime" items="${animeList}">
                    <tr>
                		<td>${anime.id}</td>
                		<td>${anime.emp_name}</td>
                		<td>${anime.emp_email}</td>
                		<td>${anime.emp_phone}</td>
                		<td>${anime.emp_address}</td>
        ...
        <button type="button" class="btn btn-primary btn-block">
        	<a href="/addAnime">Add New Employee</a>
        </button>
